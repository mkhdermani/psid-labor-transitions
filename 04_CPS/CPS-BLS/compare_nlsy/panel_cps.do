*===============================================================================
* panel_cps.do   (CPS-BLS / compare_nlsy)
*-------------------------------------------------------------------------------
* Project : PSID_SHELF
...
*           flows (EE, EU, EI, UE, UU, UI, IE, IU, II, ...). This copy feeds the
*           CPS-vs-NLSY comparison.
...
merge 1:m date_num using "D:\PSID_SHELF\04_CPS\CPS-BLS\compare_nlsy\NLSY79_SABOOK.dta", force
...
// Drop data before January 1, 2020
...
tsline tr_UE tr_unemp_to_emp_week_mean, ///
    ...
    graphregion(color(white))  yscale(log)
...
tsline tr_EU tr_emp_to_unemp_week_mean in 1/6728, ///
...
tsline tr_UI tr_unemp_to_inac_week_mean in 1/6728, ///
...
tsline tr_IU tr_inac_to_unemp_week_mean in 1/6728, ///
...
tsline tr_EI tr_emp_to_inac_week_mean in 1/6728, ///
...
tsline tr_IE tr_inac_to_emp_week_mean in 1/6728, ///
...
tsline tr_UU tr_unemp_to_unemp_week_mean in 1/6728, ///
...
tsline tr_II tr_inac_to_inac_week_mean in 1/6728, ///
